...
function setFocusMode(){
    ...
    if (result == 2) frmVideo.camerawidget.focusMode = constants.CAMERA_FOCUS_MODE_CONTINUOUS;
...
{
 var querycontext = {mimetype:"video/*"};
...
function camera_FlashMode(eventobject) {
    ...
    if (result[0][1] == "On") frmVideo.camerawidget.cameraOptions = {
        flashMode: constants.FLASH_MODE_ON
    };
    else
    if (result[0][1] == "Off") frmVideo.camerawidget.cameraOptions = {
        flashMode: constants.FLASH_MODE_OFF
    };
    else
    frmVideo.camerawidget.cameraOptions = {
...
function camera_videoFormatProperty() {
    ...
    if (result == 2) frmVideo.camerawidget.videoFormat = constants.CAMERA_VIDEO_FORMAT_MOV;
}